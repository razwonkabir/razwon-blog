...
import { ArrowLeft, Calendar, Clock, User, Tag, Share2, Check, FolderOpen, Eye } from 'lucide-react';
...
export default function PostDetails() {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-1 bg-slate-200/40 dark:bg-slate-800/40 z-[9999]">
        <div 
      ...
      >
        <div className="mx-auto max-w-4xl">
          ...
          <header className="mb-10">
            ...
            <p className="mt-4 text-base sm:text-lg leading-relaxed text-slate-600 dark:text-slate-400 border-l-2 border-slate-300 dark:border-slate-800 pl-4 italic text-justify">
              {post.summary}
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-y-2 gap-x-6 text-sm text-slate-500 dark:text-slate-400 font-mono">
              ...
              <span className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400">
                <Eye className="h-4 w-4 text-slate-400 dark:text-slate-600" />
